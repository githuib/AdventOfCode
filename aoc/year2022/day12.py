        ...
        if AOC.debugging:
            ...
            debug_table([
                ...
                ((f'{chalk.hex("034").bg_hex("bdf")("S")} start', 7),
                 'Dijkstra', len(p_dijkstra.visited), t_dijkstra),
            ] + a_star_result + [
                ((f'{chalk.hex("068").bg_hex("0af")("p")} path', 6), '', '', '', ''),
                ((f'{chalk.hex("535").bg_hex("848")("x")} visited by all algorithms (A*, Dijkstra & BFS)', 48),
                 '', '', '', ''),
                ((f'{chalk.hex("424").bg_hex("636")("y")} only visited by Dijkstra & BFS', 32), '', '', '', ''),
                ((f'{chalk.hex("212").bg_hex("424")("z")} only visited by BFS', 21), '', '', '', ''),
                ((f'{chalk.hex("222").bg_hex("333")("a")} possible starting points (including un-escapable)', 51 + 68),
                 '', '', '', ''),
                ((f'{chalk.hex("222").bg_hex("000")("w")} wild, unexplored terrain', 26), '', '', '', ''),
            ])
        return p_bfs.length
